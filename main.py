...
def cmd_help():
    ...
    print("  --run [--tier daily|weekly|all] [--dry-run] [--env <name>]")
    print("                             Lancement d'un backup")
    print("                                --tier daily : projets quotidiens (défaut)")
    print("                                --tier weekly : projets hebdomadaires")
    print("                                --tier all   : tous les projets")
